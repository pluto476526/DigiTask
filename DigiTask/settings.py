"""
Django settings for DigiTask project.
...
SECRET_KEY = 'django-insecure-%m87*rtzk(uwv@z(8lzl2yytcut&r8-a-@s-yt$if5ee^*+-m*'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'formatter': 'verbose',  # Optional: to format logs
        },
        'console': {
